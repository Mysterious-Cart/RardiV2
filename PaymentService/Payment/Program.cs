...
builder.Services.AddScoped<ReportService>()
                .AddScoped<DataManagementService>()
...
try
{
    var context = app.Services.GetRequiredService<IDbContextFactory<PaymentContext>>().CreateDbContext();
...
catch (Exception ex)
{
    ...
    throw; // Re-throw to prevent startup if seeding fails
}
